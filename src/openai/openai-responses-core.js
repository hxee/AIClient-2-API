...
export class OpenAIResponsesApiService {
    ...
    async callApi(endpoint, body, isRetry = false, retryCount = 0) {
        ...
        console.log(`[OpenAI Responses Request] Vendor: ${vendorName}, BaseURL: ${this.baseUrl}, Endpoint: ${endpoint}, Full URL: ${fullUrl}, Model: ${body.model || 'N/A'}`);
    ...
    async *streamApi(endpoint, body, isRetry = false, retryCount = 0) {
        ...
        const vendorName = this.config.vendorName || 'unknown';
        const fullUrl = `${this.baseUrl}${endpoint}`;
        console.log(`[OpenAI Responses Stream Request] Vendor: ${vendorName}, BaseURL: ${this.baseUrl}, Endpoint: ${endpoint}, Full URL: ${fullUrl}, Model: ${body.model || 'N/A'}`);
